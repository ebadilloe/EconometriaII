...
library(readxl); library(summarytools); library(marginaleffects); library(ggview)

# Cargando los datos
setwd("C:/Users/USUARIO/OneDrive - Universidad Autónoma Latinoamericana/1 Econometria/1 Econometria II-UNAULA/Clases/ModelosEleccion")
...
ggsave("fig.png", width = 4, height = 4)
